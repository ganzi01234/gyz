...
if(Math.abs(deltaY)>20){
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			int deltaY = y - mLastMotionY;
			if (mPullState == PULL_DOWN_STATE&&isHeaderRefreshEnable) {// 执行下拉
				headerPrepareToRefresh(deltaY);
				// setHeaderPadding(-mHeaderViewHeight);
			} else if (mPullState == PULL_UP_STATE&&isFooterRefreshEnable) {// 执行上拉
	...
	public boolean isHeaderRefreshEnable() {
		return isHeaderRefreshEnable;
	}

	public void setHeaderRefreshEnable(boolean isHeaderRefreshEnable) {
		this.isHeaderRefreshEnable = isHeaderRefreshEnable;
	...
	public boolean isFooterRefreshEnable() {
		return isFooterRefreshEnable;
	}

	public void setFooterRefreshEnable(boolean isFooterRefreshEnable) {
		this.isFooterRefreshEnable = isFooterRefreshEnable;
		if(isFooterRefreshEnable){
