...
import com.kaixin.android.activity.ChatActivity1;
...
//                clip.setText("");
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        if(!TextUtils.isEmpty(text) && text.toString().startsWith(ChatActivity1.COPY_IMAGE)){
            setText("");
        }
