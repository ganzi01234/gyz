...
public class PhotoUtil {
	...
	public static boolean saveToSDCard(Bitmap bitmap) {
		...
		File file = new File(KaiXinAddress.SDCARED_DOWNLOAD);
		if (!file.exists()) {
			file.mkdirs();
		}
		String fileName = UUID.randomUUID().toString() + ".jpg";
		String filePath = KaiXinAddress.SDCARED_DOWNLOAD + fileName;
	...
	public static String saveToLocal(Bitmap bm) {
		...
		FileOutputStream fileOutputStream = null;
		File file = new File(KaiXinAddress.SDCARED_IMAGES);
		if (!file.exists()) {
			file.mkdirs();
		}
		String fileName = UUID.randomUUID().toString() + ".jpg";
		String filePath = KaiXinAddress.SDCARED_IMAGES + fileName;
		File f = new File(filePath);
		if (!f.exists()) {
			try {
				f.createNewFile();
	...
	/*public int Model = 3;
	//
    public Bitmap processFilter(Bitmap imageIn) {
