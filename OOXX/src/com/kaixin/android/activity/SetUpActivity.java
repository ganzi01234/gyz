	...
	private void CancelAccountDialog() {
		...
		builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				StorageUtil.saveString(SetUpActivity.this, "username", "");
				StorageUtil.saveString(SetUpActivity.this, "nickname", "");
				StorageUtil.saveString(SetUpActivity.this, "password", "");
				StorageUtil.saveString(SetUpActivity.this, "isLogin", "");
				startActivity(new Intent(SetUpActivity.this,
						LoginActivity.class));
				finish();
